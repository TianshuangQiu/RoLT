...
from autoarbor_dataloader import data_transforms as tree_transforms
import os
...
RGB_statistics = {
    ...
    "tree": {"mean": [0.4266, 0.4126, 0.3965], "std": [0.2399, 0.2279, 0.2207]},
}
...
def get_data_transform(split, rgb_mean, rbg_std, key="default"):
    ...
    if key == "iNaturalist18":
        ...
        data_transforms["train"] = tree_transforms["train"]
    else:
        data_transforms["train"] = transforms.Compose(
            [
                transforms.RandomResizedCrop(224),
    ...
    if key == "tree":
        data_transforms["val"] = tree_transforms["val"]
        data_transforms["test"] = tree_transforms["val"]
    else:
