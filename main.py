...
from data.autoarbor_dataloader import get_dataloader
from data import dataloader
import data.autoarbor_dataloader as autoarbor_dataloader
...
data_root = {
    "ImageNet": "/datasets01_101/imagenet_full_size/061417",
    "Places": "/datasets01_101/Places365/041019",
    "iNaturalist18": "/checkpoint/bykang/iNaturalist18",
    "Cifar": "./data/Cifar",
    "tree": "/home/sandeepmukh/autoarborist/data/aerial_images/train",
}
...
if config["model_dir"] is not None and args.model_dir is None:
    model_suffix = (
        f"_{args.imb_type}_{args.imb_factor}_{args.noise_mode}_{args.feat_noise_ratio}"
    )
    if args.cleaning:
...
print("Loading autoarborist dataset")
...
def get_imbalance_cifar(dataset, args):
    ...
    train_dataset = autoarbor_dataloader.my_datasets["train"]
    valid_dataset = autoarbor_dataloader.my_datasets["val"]
    ...
    #         root="./data/Cifar", train=False, download=True, transform=transform_val
    #     )
