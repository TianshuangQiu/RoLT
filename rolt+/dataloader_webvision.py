    ...
    def __init__(
        ...
        if self.mode == "test":
            ...
            print(
                max(img_num_list),
                min(img_num_list),
                max(img_num_list) / min(img_num_list),
            )
            ...
            if self.mode == "all":
                ...
                if self.mode == "labeled":
                    ...
                    print(
                        "%s data has a size of %d" % (self.mode, len(self.train_imgs))
                    )
...
class webvision_dataloader:
    ...
    def run(self, mode, pred=[], prob=[], refine_labels=None, imb_factor=1):
        if mode == "warmup":
            ...
            labeled_dataset = webvision_dataset(
                root_dir=self.root_dir,
                transform=self.transform_train,
                mode="labeled",
                num_class=self.num_class,
            ...
            unlabeled_dataset = webvision_dataset(
                root_dir=self.root_dir,
                transform=self.transform_train,
                mode="unlabeled",
                num_class=self.num_class,
            ...
            eval_dataset = webvision_dataset(
                root_dir=self.root_dir,
                transform=self.transform_test,
                mode="all",
                num_class=self.num_class,
...
class treevision_dataset(Dataset):
    def __init__(
        self,
        root_dir,
        transform,
        ...
        if self.mode == "test":
            with open("config/tree/test.txt") as f:
                lines = f.readlines()
            self.val_imgs = []
            self.val_labels = {}
            for line in lines:
            ...
            with open("config/tree/train.txt") as f:
                lines = f.readlines()
            train_imgs = []
            self.train_labels = {}
            i = 0
...
class treevision_dataloader:
    ...
    def run(self, mode, pred=[], prob=[], refine_labels=None, imb_factor=1):
        if mode == "warmup":
            all_dataset = treevision_dataset(
                root_dir=self.root_dir,
                transform=self.transform_train,
                mode="all",
                num_class=self.num_class,
            ...
            labeled_dataset = treevision_dataset(
                root_dir=self.root_dir,
                transform=self.transform_train,
                mode="labeled",
                num_class=self.num_class,
            ...
            unlabeled_dataset = treevision_dataset(
                root_dir=self.root_dir,
                transform=self.transform_train,
                mode="unlabeled",
                num_class=self.num_class,
            ...
            test_dataset = treevision_dataset(
                root_dir=self.root_dir,
                transform=self.transform_test,
                mode="test",
                num_class=self.num_class,
            ...
            eval_dataset = treevision_dataset(
                root_dir=self.root_dir,
                transform=self.transform_test,
                mode="all",
                num_class=self.num_class,
            ...
            imagenet_val = treevision_dataset(
                mode="train",
                root_dir=self.root_dir,
                transform=self.transform_imagenet,
                num_class=self.num_class,
